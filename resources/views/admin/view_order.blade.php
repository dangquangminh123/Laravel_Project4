          ...
          <tbody>
            ...
            @foreach($order_details as $key => $details)
              ...
              <tr class="color_qty_{{$details->product_id}}">
                  ...
                  <td>
                    <input type="number" min="1" {{$order_status==2 ? 'disabled' : ''}} class="order_qty_{{$details->product_id}}" value="{{$details->product_sales_quantity}}" 
                    ...
                    <button class="btn btn-default update_quantity_order" data-product_id="{{$details->product_id}}" 
                      name="update_quantity_order">Cập nhập</button>
                    @endif
                  </td>
                ...
                @foreach($order as $key => $or)
                  ...
                  <form>
                    ...
                    <select class="form-control order_details">
                      <option value="">---Xác nhận trạng thái đơn hàng-----</option>
