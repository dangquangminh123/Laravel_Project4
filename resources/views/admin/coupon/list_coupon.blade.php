        ...
        <button class="btn btn-sm btn-default">Apply</button> --}}
            ...
            <div class="table-responsive">
                    ...
                    <tbody>
                        @foreach ($coupon as $key => $cou)
                            <tr>
                                ...
                                <td>{{ date('d/m/Y', $cou->coupon_date_start) }}</td>
                                <td>{{ date('d/m/Y', $cou->coupon_date_end) }}</td>
              ...
              ?>
                ...
                ?>
                                        <span style="color: green">Được áp dụng</span>
                                        <?php
                  }else {
                ?>
                ...
                ?>
                                ...
                                <td>
                                    @if ($cou->coupon_date_end <= $now)
                                        <span style="color: red">Hêt hạn sử dụng</span>
                                    @else
                                        <span style="color:green">Còn hạn sử dụng</span>
                                    @endif
                                </td>
                                <td>
                                    <a onclick="return confirm('Bạn có chắc muốn mã giảm giá này không ?')"
                                ...
                                <td>
                                    <p><a href="{{ url('/send-coupon-vip', [
                                        ...
                                        'coupon_code' => $cou->coupon_code,
                                            ...
                                            class="btn btn-primary" style="margin: 5px 0;">Gửi mã giảm giá khách vip</a></p>
