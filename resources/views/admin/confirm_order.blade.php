...
<body>
    <div class="container" style="background: #222;border-radius: 12px; padding: 15px;">
        <div class="col-md-12">
            ...
            <div class="row" style="background: rgb(235, 58, 4); padding: 15px">
                <div class="col-md-6" style="text-align: center; color: #fff; font-weight: bold; font-size: 30px">
                    <h4 style="margin:0">CÔNG TY BÁN HÀNG LARAVEL (TEAM THẢM HẠI)</h4>
                    <h6 style="margin:0">DỊCH VỤ BÁN HÀNG - VẬN CHUYỂN - NHẬP KHẨU CHUYÊN NGHIỆP</h6>
                </div>

                <div class="col-md-6 logo" style="color: #fff">
                    <p>Chào bạn<strong style="color: #000; text-decoration: underline;">{{$shipping_array['customer_name']}}
                    </strong>,chúng tôi đã xác nhận bạn đã đặt hàng ở công ty chúng tôi gồm những thông tin như sau:</p>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <p>Mã đơn hàng: <strong style="text-transform: uppercase; color:#fff">{{$code['order_code']}}
                    </strong></p>
                    <p>Mã khuyến mãi áp dụng: <strong style="text-transform: uppercase; color:#fff">{{$code['coupon_code']}}
                    </strong></p>
                    <p>Phí ship hàng: <strong style="text-transform: uppercase; color:#fff">{{$shipping_array['fee_ship']}}
                    </strong></p>
                    ...
                    <p style="color: #fff">Nếu thông tin người nhận hàng không có chúng tôi sẽ liên hệ với người đặt hàng để
                    ...
                    <table class="table table-striped" style="border: 1px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="4" align="right">Tổng tiền thanh toán: {{number_format($total,0,',','.')}}$</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <p style="color: #fff; text-align:center; font-size: 15px;">Xem lại lịch sử đơn hàng đã đặt tại: <a target="_blank" href="{{url('/history')}}">
                    Lịch sử đơn hàng đã đặt</a></p>
                <p style="color: #fff">Mọi chi tiết xin liên hệ website tại: <a target="_blank" href="https://localhost:8080/shopbanhang/">
                Shop</a>, hoặc liên hệ qua số hotline: 19005689.Xin cảm ơn quý khách đã đặt hàng shop chúng tôi.</p>
            </div>
        </div>
    </div>
</body>
