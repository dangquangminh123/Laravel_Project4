      ...
      <table class="table table-striped b-t b-light" id="myTable">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{url('/edit-post/'.$post->post_id)}}" class="active styling-edit" ui-toggle-class="">
                <i class="fa fa-pencil-square-o text-success text-active"></i></a>
              <a onclick="return confirm('Bạn có chắc muốn xóa bài viết này không ?')" 
              href="{{url('/delete-post/'.$post->post_id)}}" class="active styling-edit" ui-toggle-class="">
