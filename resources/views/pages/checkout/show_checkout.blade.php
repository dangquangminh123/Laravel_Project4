    ...
    <div class="container">
                    ...
                    <div class="bill-to">
                        ...
                        <div class="form-one">
                            <form method="POST">
                                ...
                                <textarea name="shipping_notes" class="shipping_notes" placeholder="Thêm thông tin về đơn hàng của bạn" rows="5"></textarea>

                                @if(Session::get('fee'))
                                    <input type="hidden" name="order_fee" class="order_fee" value="{{Session::get('fee')}}">
                                @else
                                    <input type="hidden" name="order_fee" class="order_fee" value="2">
                                @endif
                                ...
                                <input type="button" value="Xác nhận đơn hàng" name="send_order" class="btn btn-success btn-sm
                                send_order"/>
                            </form>
                            <form role="form">
                                @csrf
                                ...
                                class="btn btn-success btn-sm calculate_delivery" />
                            </form>
        ...
        <div class="col-sm-12 clearfix">
                        ...
                        <div class="table-responsive cart_info">
                            ...
                            <table class="table table-condensed">
                                ...
                                <tbody>
                                    ...
                                    <td colspan="2">
                                            <li>Tổng tiền:<span>{{number_format((int)$total,0,',','.')}}$</span></li>
                                            @if(Session::get('coupon'))
                                            <li>   
                                                    @foreach(Session::get('coupon') as $key => $cou)
                                                        ...
                                                        @elseif($cou['coupon_condition']==2) 
                                                            Mã giảm: {{number_format((int)$cou['coupon_number'],0,',','.')}} $
                                                            <p>
                                                                @php
                    ...
                    <li>
                        ...
                        Phí vận chuyển <span>{{number_format((int)Session::get('fee'),0,',','.')}}$</span></li>
                ...
                <li>Tổng tiền còn:
                    @php
                        if(Session::get('fee') && !Session::get('coupon')) {
                            ...
                            echo (number_format((int)$total_after,0,',','.').'$'); 
        ...
        @else 
            <tr>
                <td colspan="5"><center>
                     @php 
                     echo 'Hãy thêm sản phẩm vào trong giỏ hàng';
                    @endphp
                </center></td>
            </tr>
              @endif
