...
{{-- <input type="hidden" value="{{$value->product_slug}}" id="viewed_productslug"> --}}
...
<input type="hidden" value="{{number_format($value->product_price,0,',','.')}}$" id="viewed_productprice{{$value->product_id}}">
<div class="product-details"><!--product-details-->
    <style type="text/css">
       ...
       li.active {
        border: 2px solid #EF980F;
       }
    </style>
    <ul class="breadcrumb" style="background: none">
        <li><a href="{{url('/')}}">Trang chủ</a></li>
        <li><a href="{{url('/danh-muc-san-pham/'.$cate_slug)}}">{{$product_cate}}</a></li>
    ...
    {{-- Thêm giỏ hàng bằng thư viện bumblemen --}}
    {{-- <div class="col-sm-7">
        ...
        <div class="product-information">
            ...
            @csrf
                ...
                <span>
                    <span>{{number_format($value->product_price,0,',','.').'$'}}</span>
                    <label>Số lượng:</label>
                    <input type="number" name="qty" min="1" class="cart_product_qty_{{$value->product_id}}" value="1" />
                   
                    <input type="hidden" name="productid_hidden" value="{{$value->product_id}}" />
                </span>
                <input type="button" value="thêm giỏ hàng" class="btn btn-default btn-sm add-to-cart" data-id_product="{{$value->product_id}}"
                 name="add-to-cart" />
            </form>
            <p><b>Tình trạng:</b> Còn hàng</p>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade active in" id="reviews" >
            <div class="col-sm-12">
                ...
                <form action="#">
                    <span>
                        <input style="width: 100%; margin-left:0px" type="text" class="comment_name"
                         placeholder="Tên bạn"/>
                    </span>
                    ...
                    <div class="product-image-wrapper">
                        <div class="single-products">
                            <div class="productinfo text-center">
                                <img src="{{url('public/uploads/product/'.$lienquan->product_image)}}" alt="" />
