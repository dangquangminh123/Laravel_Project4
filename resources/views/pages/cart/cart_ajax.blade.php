                            ...
                            <td colspan="2">
                                    ...
                                    <li>   
                                            @foreach(Session::get('coupon') as $key => $cou)
                                                @if($cou['coupon_condition']==1)
                                                    ...
                                                    <p>
                                                        @php
                                                            ...
                                                            echo '<p><li>Tổng giảm:'.number_format((int)$total_coupon,0,',','.').'$</li></p>';
                                                        @endphp
                                                    </p>
                                                    <p><li>Tổng tiền phải trả{{number_format((int)$total-$total_coupon,0,',','.')}}$</li></p>
                                                ...
                                                <p><li>Tổng tiền phải trả{{(int)number_format($total_coupon,0,',','.')}}$</li></p>
                                                @endif
                                            @endforeach
                                    </li>
                                    @endif
