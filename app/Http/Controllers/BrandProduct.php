...
class BrandProduct extends Controller
{
    ...
    public function unactive_brand_product($brand_product_id) {
        ...
        Session::put('message','Tắt thương hiệu sản phẩm thành công');
    ...
    public function show_brand_home(Request $request, $brand_slug) {
        ...
        $brand_name = Brand::where('brand_slug',$brand_slug)->first();

        $meta_desc = $brand_name->brand_desc;
        $meta_keywords = $brand_name->brand_slug;
        ...
        if(isset($_GET['brand'])){
            ...
            ->whereIn('tbl_product.brand_id',$brand_arr)->get();
        }else {
            $brand_by_id = DB::table('tbl_product')
            ->join('tbl_brand','tbl_product.brand_id','=','tbl_brand.brand_id')
            ->where('tbl_product.brand_id',$brand_name->brand_id)->get();
        }
