...
class VideoController extends Controller
{
    ...
    public function delete_video(Request $request) {
        ...
        unlink('public/uploads/videos/'.$video->video_images);    
        $video->delete();       
    }
            ...
            foreach($video as $key => $vid){
                ...
                $output.='
                    <tr>
                       ...
                       <td>  
                        <img src="'.url('public/uploads/videos/'.$vid->video_images).'" class="img-thumbnail" 
    ...
    public function video_shop(Request $request) {
          ...
          //seo
          $meta_desc = "Videos của shop";
          $meta_keywords = "Video mô hình và team thảm hại";
          $meta_title = "Video | Eshop";
          $url_canonical = $request->url();
          
          $cate_product = DB::table('tbl_category_product')->where('category_status','1')->orderby('category_id','desc')->get();
          $brand_product = DB::table('tbl_brand')->where('brand_status','1')->orderby('brand_id','desc')->get();
        // $product_all = DB::table('tbl_product')->paginate(10);
          $all_videos = DB::table('tbl_videos')->paginate(6);
  
          return view('pages.video.video')->with('category',$cate_product)->with('brand',$brand_product)->with('meta_desc',$meta_desc)
          ->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)
          ->with('slider',$slider)->with('category_post',$category_post)->with('all_videos',$all_videos);
    }
    ...
    public function watch_video(Request $request){
        ...
        $output['video_link'] = '<iframe width="100%" height="400" src="https://www.youtube.com/embed/'.$video->video_link.'"
            title="YouTube video player" frameborder="0" allow="accelerometer;autoplay; clipboard-write; 
            encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';

        // $output['video_link'] = '<video id="my_yt_video" class="vlite-js" data-youtube-id="'.$video->video_link.'"></video>';
