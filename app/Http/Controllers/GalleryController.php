...
class GalleryController extends Controller
{
    ...
    //     $this->AuthLogin();
    //     $gallery = Gallery::orderBy('gallery_id ','ASC')->get();
    //     $list_gallery = Gallery::orderBy('gallery_id')->paginate(10);
       
    //     return view('admin.gallery.list_gallery')->with(compact('gallery','list_gallery'));
    ...
    public function insert_gallery(Request $request, $pro_id) {
        ...
        if($get_image){
            foreach($get_image as $image){
                ...
                $new_image = $name_image.Str::random(10).'.'.$image->getClientOriginalExtension();
            ...
            foreach($gallery as $key => $gal){
                ...
                $output.='
                    <tr>
                        ...
                        <td><button type="button" data-gal_id="'.$gal->gallery_id.'" class="btn btn-xs btn-danger delete-gallery">Xóa</button>
                        </td>
                    </tr>';
            }
        }else {
